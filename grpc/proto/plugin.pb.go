...
var file_plugin_proto_depIdxs = []int32{
	...
	5,  // 60: proto.DescribeResponse.CustomFormatsEntry.value:type_name -> proto.FormatDescription
	29, // 61: proto.SourceMetadata.PropertiesEntry.value:type_name -> proto.PropertyMetadata
	39, // 62: proto.RowErrors.ErrorsEntry.value:type_name -> proto.RowErrorsByOperation
	40, // 63: proto.RowErrorsByOperation.OperationErrorsEntry.value:type_name -> proto.OperationErrorAggregate
	3,  // 64: proto.TailpipePlugin.Describe:input_type -> proto.DescribeRequest
	0,  // 65: proto.TailpipePlugin.AddObserver:input_type -> proto.Empty
	1,  // 66: proto.TailpipePlugin.Collect:input_type -> proto.CollectRequest
	33, // 67: proto.TailpipePlugin.InitSource:input_type -> proto.InitSourceRequest
	2,  // 68: proto.TailpipePlugin.UpdateCollectionState:input_type -> proto.UpdateCollectionStateRequest
	0,  // 69: proto.TailpipePlugin.CloseSource:input_type -> proto.Empty
	0,  // 70: proto.TailpipePlugin.SaveCollectionState:input_type -> proto.Empty
