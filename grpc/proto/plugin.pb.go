...
type CollectRequest struct {
	...
	TempCacheMaxMb int64 `protobuf:"varint,12,opt,name=temp_cache_max_mb,json=tempCacheMaxMb,proto3" json:"temp_cache_max_mb,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CollectRequest) GetTempCacheMaxMb() int64 {
	if x != nil {
		return x.TempCacheMaxMb
	}
	return 0
}
...
const file_plugin_proto_rawDesc = "" +
	...
	"\x11temp_cache_max_mb\x18\f \x01(\x03R\x0etempCacheMaxMb\"\xbf\x01\n" +
