...
// this is used for tables which proecees the artifact directly, e.g. cav table which converts the csv directly to JSONL
...
func (g NullLoader) Load(_ context.Context, _ *types.ArtifactInfo, dataChan chan *types.RowData) error {
