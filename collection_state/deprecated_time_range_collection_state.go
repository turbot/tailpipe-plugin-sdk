...
// DeprecatedTimeRangeCollectionState is a collection state that tracks time ranges of collected data from contiguous and non-contiguous sources.
...
type DeprecatedTimeRangeCollectionState[T parse.Config] struct {
...
func NewDeprecatedTimeRangeCollectionState[T parse.Config]() CollectionState[T] {
	return &DeprecatedTimeRangeCollectionState[T]{}
}

// Init initializes the collection state with the provided configuration
func (s *DeprecatedTimeRangeCollectionState[T]) Init(config T, path string) error {
...
func (s *DeprecatedTimeRangeCollectionState[T]) StartCollection() {
...
func (s *DeprecatedTimeRangeCollectionState[T]) EndCollection() {
	// merge ranges
	s.Ranges = s.mergeRanges()
}

// IsEmpty returns true if there are no ranges in the collection state
func (s *DeprecatedTimeRangeCollectionState[T]) IsEmpty() bool {
	return len(s.Ranges) == 0
}

// ShouldCollectRow returns true if the row should be collected based on the time and provided key identifier
func (s *DeprecatedTimeRangeCollectionState[T]) ShouldCollectRow(ts time.Time, key string) bool {
...
func (s *DeprecatedTimeRangeCollectionState[T]) Upsert(ts time.Time, key string, meta any) {
	if meta == nil {
		meta = struct{}{}
	}
...
func (s *DeprecatedTimeRangeCollectionState[T]) addNewRange() *CollectionStateTimeRange {
...
func (s *DeprecatedTimeRangeCollectionState[T]) getEarliestRange() *CollectionStateTimeRange {
	if len(s.Ranges) == 0 {
		return nil
	}
...
func (s *DeprecatedTimeRangeCollectionState[T]) getLatestRange() *CollectionStateTimeRange {
	if len(s.Ranges) == 0 {
		return nil
	}
...
func (s *DeprecatedTimeRangeCollectionState[T]) GetLatestEndTime() *time.Time {
	if len(s.Ranges) == 0 {
		return nil
	}
...
func (s *DeprecatedTimeRangeCollectionState[T]) GetEarliestStartTime() *time.Time {
	if len(s.Ranges) == 0 {
		return nil
	}
...
func (s *DeprecatedTimeRangeCollectionState[T]) mergeRanges() []*CollectionStateTimeRange {
